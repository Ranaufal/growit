            ...
            <div class="col-md-6">
                <div class="login-container">
                  <form method="POST" action="/register">
                        ...
                        <div class="form-control mt-4" style="background-color: transparent; border:none;">
                            ...
                            <input type="text" class="form-control text-white" name="name"style="background: rgba(255, 255, 255, 0.16);
                            border-radius: 16px;
                            box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);
                            backdrop-filter: blur(5px);
                            -webkit-backdrop-filter: blur(5px);
              ...
              @enderror"
                        ...
                        <div class="row justify-content-center px-6">
                            <button type="submit" class="round btn btn-grow text-center mb-3 btntext">Sign Up</button>

                        </div>
                        <div class="row justify-content-center mt-2">
                            <p class="text-center text-white">Already have an Account?
                                <a href="/login" class="align-items-center btntextr">Login</a>
